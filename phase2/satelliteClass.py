...
class satellite:
    ...
    def update_ci_estimator(self, measurement, target, time):
        ...
        if len(self.ciEstimator.estHist[target.targetID]) < 1: # if this is an empty dictionary, initialize the filter
    ...
    def update_et_estimator(self, measurement, target, time):
        ...
        local_et_estimator = self.etEstimators[0] # get the local et estimator for this satellite
