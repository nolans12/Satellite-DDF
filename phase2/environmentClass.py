...
from estimatorClass import (centralEstimator, ciEstimator, etEstimator,
                            indeptEstimator)
            ...
            for sat in self.sats:
                if targ.targetID in sat.targetIDs:
                    ...
                    if self.centralEstimatorBool:
                        ...
                        central_innovation_times = [
                            time
                            for time in time_vec.value
                            if time in central_innovationHist
                        ]
                    ...
                    if self.etEstimatorBool:
                        ...
                        et_innovation_times = [
                            time for time in time_vec.value if time in et_innovationHist
                        ]
                        et_trackError_times = [
